...
export function Movies() {
    ...
    const { arrAllMergedData, title, sQuery, lastEleRef } = useFetchMovies(observer);
    ...
    return (<div className='bg-black px-[30px] max-sm:px-[15px] min-w-xs min-h-screen'>
        <header className="sticky top-0 z-30 flex items-center w-full max-sm:h-[96px] max-md:h-[144px] max-lg:h-[192px] bg-[url('./../public/resources/Slices/nav_bar.png')] bg-no-repeat bg-cover">
